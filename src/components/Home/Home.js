                    ...
                    <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">
                       ...
                       <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src={Object.values(catalogo[1].imagen)} class="d-block" />
                                <div>
                            ...
                            <div class="carousel-item">
                                <img src={Object.values(catalogo[3].imagen)} class="d-block" />
                                <div>
                            ...
                            <div class="carousel-item">
                                <img src={Object.values(catalogo[5].imagen)}class="d-block" />
                                <div>
